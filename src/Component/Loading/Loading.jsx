            ...
            <div className='flex justify-center items-center mt-20'>
                <div className="preloader ">
                    ...
                    <div className="preloader__text">
                        <p className="preloader__msg text-primary">Bringing you the goods…</p>
                        <p className="preloader__msg preloader__msg--last text-primary">This is taking long. Something’s wrong.</p>
                    </div>
                </div>
            </div>
        </>
